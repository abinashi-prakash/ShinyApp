...
###1) need to create a Shiny application and deploy it on Rstudio's servers.
...
b) The application is running on (https://abinashiprakash.shinyapps.io/Reproducible_Pitch/).            
